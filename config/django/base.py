...
LOCAL_APPS = [
    'concurrency.core.apps.CoreConfig',
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'concurrency.api.exception_handlers.drf_default_with_modifications_exception_handler',
    # 'EXCEPTION_HANDLER': 'concurrency.api.exception_handlers.hacksoft_proposed_exception_handler',
